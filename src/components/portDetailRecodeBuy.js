            ...
            <Dialog fullScreen open={open} onClose={handleClose} TransitionComponent={Transition}>
                ...
                <Grid Container className = {classes.root} >
                    <Grid item className = {classes.title}>
                        <Typography  className = {classes.bodyTitleText} >BA-BUY</Typography> 
                    </Grid>

                    <Grid item className = {classes.mainPart}>
                        <Grid Container className = {classes.mainSpace}>
                            <Grid className = {classes.mainContentLeft}>
                                <Typography  className = {classes.bodyMainText} >매수가</Typography>
                            </Grid>
                        ...
                        <Grid Container className = {classes.mainPart}>
                            <Grid className = {classes.mainContentLeft}>
                              <Typography  className = {classes.bodyMainText} >매수 수량</Typography>
                            </Grid>
                            <Grid className = {classes.mainContentRight}>
                                <Input inputProps={{ 'aria-label': 'description' }} />
                            </Grid>
                        ...
                        <Grid Container className = {classes.mainPart}>
                            <Grid className = {classes.mainContentLeft}>
                                <Typography  className = {classes.bodyMainText} >매수 날짜</Typography>
                            </Grid>
                            <Grid className = {classes.mainContentRight}>
